...
you can see in the following image, the code frequency is steady throughout
the years:

image:images/quarkus-code.png[]

And as you can see the release frequency follows the same line:

image:images/quarkus-tags.png[]

However, the real value of this community is in its approach to
